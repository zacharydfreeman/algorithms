...
const job1 = [6, 1, 5, 2, 4, 3], d1 = 2; // 9
const job2 = [6,5,4,3,2,1], d2 = 2; // 7
const job3 = [1, 1, 1], d3 = 3; // 3
const job4 = [2, 1, 1], d4 = 4; // -1
const job5 = [11,111,22,222,33,333,44,444], d5 = 6; // 843
