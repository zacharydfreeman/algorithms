...
const _getLowestCommonAncestor = (current, p, q) => {
    ...
    if (current === null) return {lowestCommonAncestor: null, numOfDescendants: 0};
    ...
    currentNumOfDescendants += leftTreeInfo.numOfDescendants + rightTreeInfo.numOfDescendants;
    ...
    return {lowestCommonAncestor: lowestCommonAncestor, numOfDescendants: currentNumOfDescendants};
}
